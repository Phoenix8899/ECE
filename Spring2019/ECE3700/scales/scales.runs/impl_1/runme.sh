...
HD_PWD='/home/phoenix8899/Sine_Synth/Sine_Synth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Synth_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Synth_Top.tcl -notrace
