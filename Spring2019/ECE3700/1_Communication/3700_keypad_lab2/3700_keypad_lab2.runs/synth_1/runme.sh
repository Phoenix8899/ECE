...
HD_PWD='/home/phoenix8899/ECE/Spring2019/ECE3700/1_Communication/3700_keypad_lab2/3700_keypad_lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keypad_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source keypad_demo.tcl
