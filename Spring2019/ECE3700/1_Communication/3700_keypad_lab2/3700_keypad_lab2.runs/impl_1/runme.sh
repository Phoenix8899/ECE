...
HD_PWD='/home/phoenix8899/ECE/Spring2019/ECE3700/1_Communication/3700_keypad_lab2/3700_keypad_lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keypad_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keypad_demo.tcl -notrace
