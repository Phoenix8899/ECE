...
HD_PWD='/home/ecestudent/Junk/DSM_junk/DSM_junk.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Synth_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Synth_Top.tcl
