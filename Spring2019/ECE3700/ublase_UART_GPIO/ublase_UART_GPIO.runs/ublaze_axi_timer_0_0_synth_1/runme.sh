...
HD_PWD='/home/phoenix8899/ECE/Spring2019/ECE3700/ublase_UART_GPIO/ublase_UART_GPIO.runs/ublaze_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ublaze_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ublaze_axi_timer_0_0.tcl
