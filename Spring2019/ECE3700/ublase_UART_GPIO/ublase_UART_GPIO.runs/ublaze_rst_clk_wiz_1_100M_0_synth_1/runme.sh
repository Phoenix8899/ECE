...
HD_PWD='/home/phoenix8899/ECE/Spring2019/ECE3700/ublase_UART_GPIO/ublase_UART_GPIO.runs/ublaze_rst_clk_wiz_1_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ublaze_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ublaze_rst_clk_wiz_1_100M_0.tcl
