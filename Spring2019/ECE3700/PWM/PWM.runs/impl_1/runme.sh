...
HD_PWD='/home/phoenix8899/ECE/Spring2019/ECE3700/PWM/PWM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dim_leds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dim_leds.tcl -notrace
