...
HD_PWD='/home/phoenix8899/ECE/Spring2019/ECE3700/PWM/PWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dim_leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dim_leds.tcl
