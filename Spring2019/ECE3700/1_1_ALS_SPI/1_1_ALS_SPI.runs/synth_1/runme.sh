...
HD_PWD='/home/phoenix8899/ECE/Spring2019/ECE3700/1_Communication/1_1_ALS_SPI/1_1_ALS_SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALS.tcl
