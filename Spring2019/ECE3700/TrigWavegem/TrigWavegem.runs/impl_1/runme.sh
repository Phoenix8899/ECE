...
HD_PWD='/home/phoenix8899/ECE/Spring2019/ECE3700/TrigWavegem/TrigWavegem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TrigTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TrigTop.tcl -notrace
