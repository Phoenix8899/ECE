...
HD_PWD='/home/phoenix8899/ECE/Spring2019/ECE3700/TrigWavegem/TrigWavegem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TrigTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TrigTop.tcl
